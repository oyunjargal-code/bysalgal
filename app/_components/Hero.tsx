    ...
    <div>
     ...
     <div>
      <div className='bg-[#eeece9] w-fit flex flex-col mt-10 text-center p-2'>
        ...
        <h1>Дхамма-Махаана</h1>
        <h1>Випашяна бол Энэтхэгийн эртний бясалгалын нэг техник бөгөөд оюун санааны бохирдлыг арилгаж, дээд аз жаргалыг олж авах арга зам юм.</h1>
      </div>
      <div>
        <button className='border flex'>Бүртгүүлэх <ArrowRight /></button>
